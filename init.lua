...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      --
      -- Servers needing settings are configured in after/lsp/<name>.lua
      local servers = {
        'clangd',
        'gopls',
        'pyright',
      ...
      -- Tools for Mason to install. Run `:Mason` to browse status; `g?` for help.
      -- Add non-LSP tools (formatters, linters) to the list below.
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Using vim-surround style mappings for core operations:
      -- - ysiw) - [Y]ank [S]urround [I]nner [W]ord [)]Paren
      -- - ds'   - [D]elete [S]urround [']quotes
      -- - cs)'  - [C]hange [S]urround [)] [']
      --
      -- Plus mini.surround extras with gs prefix:
